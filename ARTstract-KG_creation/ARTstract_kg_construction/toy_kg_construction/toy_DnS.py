...
with open('input/toy-annotation-situations.json', 'r') as json_file:
...
with open("output/situations_kg.ttl", "w") as outfile:  # Open in regular text mode (not binary mode)
